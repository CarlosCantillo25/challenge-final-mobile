...
const TechsPage = (props) => {
  ...
  setCurrentPage(currentPage - 1)
   ...
   <View style={styles.cont_buton}>
    <TouchableHighlight onPress={handlePrev} disabled={techs.prevPage === null} style={styles.boton}><Text style={styles.arrow}>Prev page</Text></TouchableHighlight>
    <Text>Page{currentPage}</Text>
    <TouchableHighlight onPress={handleNext} disabled={ techs.nextPage === null} style={styles.boton}><Text style={styles.arrow}>Next page</Text></TouchableHighlight>
   </View>
  ...
  <View style={styles.cont_buton}>
    <TouchableHighlight onPress={handlePrev} disabled={techs.prevPage === null} style={styles.boton}><Text style={styles.arrow}>Prev page</Text></TouchableHighlight>
    <Text>Page{currentPage}</Text>
    <TouchableHighlight onPress={handleNext} disabled={techs.nextPage === null} style={styles.boton}><Text>Next page</Text></TouchableHighlight>
   </View>
  </View>
  </ScrollView>
    )
